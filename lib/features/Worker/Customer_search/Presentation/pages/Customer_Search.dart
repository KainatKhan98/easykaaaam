...
class CustomerMapSearch extends StatefulWidget {
  const CustomerMapSearch({super.key});

  @override
  State<CustomerMapSearch> createState() => _CustomerMapSearchState();
}

class _CustomerMapSearchState extends State<CustomerMapSearch> {
